...
include('../../login-cadastro/conexao.php');
 ...
 $sql90=$pdo->prepare("INSERT INTO  localidads  ( localidad_id,  char_localidad  ,  localidad_local  ,  localidads_html  ,  localidads_src  ) VALUES(NULL, '$name_1','$local', '../cen/hotel_golden_star/tela_04_cen.php','../img_geral/LAPIDE-SEMINOVA-D.png')");
 $sql90-> execute();
...
<html>
	...
	<body>
		...
		<div class="cen_box_title" >
			<p class="text_cen_box"> As ruas estão cobertas de grama, calçada e neve. acima h a muitas neves indo e voltando. </p> 
		</div>
        <a href="tela_02_cen.php"> 
		<div class="cen_box" >
			<p class="text_cen_box" > Seguir a direita   </p> 
		</div></a>
        <a href="tela_01_cen.php"> 
		<div class="cen_box" >
			<p class="text_cen_box" > Seguir a esquerda   </p> 
		</div></a>
