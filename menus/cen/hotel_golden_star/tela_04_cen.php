...
include('../../../login-cadastro/db/conexao.php');
 ...
 $sql90=$pdo->prepare("INSERT INTO  localidads  ( localidad_id,  char_localidad  ,  localidad_local  ,  localidads_html  ,  localidads_src  ) VALUES(NULL, '$name_1','$local', '../cen/hotel_golden_star/tela_04_cen.php','../../../LAPIDE-SEMINOVA-D.png')");
 $sql90-> execute();
