...
include('../../login-cadastro/conexao.php');
 ...
 $sql90=$pdo->prepare("INSERT INTO  localidads  ( localidad_id,  char_localidad  ,  localidad_local  ,  localidads_html  ,  localidads_src  ) VALUES(NULL, '$name_1','$local', '../cen/hotel_golden_star/tela_07_cen.php','../img_geral/LAPIDE-SEMINOVA-D.png')");
 $sql90-> execute();
...
<html>
	...
	<body>
		...
		<div class="cen_box_title" >
			<p class="text_cen_box"> QUEST00005-017)[QUEST ADD]  </p> 
		</div>
        <a href="tela_03_cen.php"> 
		<div class="cen_box" >
			<p class="text_cen_box" > Voltar ao menu ALbun </p> 
		</div></a>
