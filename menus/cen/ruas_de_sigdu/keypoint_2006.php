...
andar 1---
<div class='cen_box' style='padding : 9px'>Sigdu > Rua eskive> (20,6)  <br></div>


<form action='./keypoint_2013.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Sul---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='./keypoint_2007.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Leste---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='./keypoint_2005.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Oeste---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
