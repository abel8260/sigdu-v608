...
andar 1---
<div class='cen_box' style='padding : 9px'>Sigdu > Rua eskive > (21,2)  <br></div>


<form action='./keypoint_2002.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Norte---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='./keypoint_2008.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Oeste---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='./keypoint_2010.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Leste---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='./keypoint_2016.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>Sul---<br/>normal---<br/>rua-eskive---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
