...
<head>
  ...
  <!--básico-->  
            <meta charset="UTF-8"/>  
            <title>Escolha de tipo de comunidade;</title>
...
<div class="caixa04" >
  ...
  <br>
   <a class= "menu" href="key_30.php">voltar</a>
    <br>
</div>
<h1>Suas opções <br> de organizações</h1>

  <a  id="img01" href = "../process/myChoice01.php" ><img src= "../img_geral/clan_01.png"></img></a>
  <!--<a  id="img02" href = "../process/myChoice02.php" ><img src= "../img_geral/guilda_01.png"></img></a>-->
